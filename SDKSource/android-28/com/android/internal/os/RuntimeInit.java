...
public class RuntimeInit {
     ...
     * 还记这个全限定名参数吗？？这个就是我们上文AMS将请求任务转移给Process中在最后强调的那个参数：android.app.ActivityThread
    ...
    protected static Runnable findStaticMain(String className, String[] argv,
         ...
         * up the process.
         * 通过main方法来构造MethodAndArgsCaller
         */
    ...
    protected static Runnable applicationInit(int targetSdkVersion, String[] argv,
        ...
        // 我们可以看到这个方法最终调用了findStaticMain。下面我们来看一下这个方法的执行
    ...
    static class MethodAndArgsCaller implements Runnable {
        ...
        /**
         * RuntimeInit的一个内部类并且继承了Runnable,然后在run方法中会通过反射调用了mMethod方法
         * mMethod是ActivityThread的main方法，即run方法中将会执行ActivityThread的main方法
         */
        public void run() {
            try {
