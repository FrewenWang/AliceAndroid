...
public class Activity extends ContextThemeWrapper
    ...
    /**
     * @hide
     * 从源码中，我们可以看到startActivity最终就是调用的startActivityForResult的方法。
     */
    @Override
    @UnsupportedAppUsage
    public void startActivityForResult(
        ...
        // 可以很简单我们看到调用Instrumentation的execStartActivity
        // 这个Instrumentation是什么？为什么要交给她弄呢？
        // 其实Instrumentation这个类很重要，重要体现在对Activity生命周期的调用根本离不开她。
