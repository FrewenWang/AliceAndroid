...
public class Handler {
     ...
     * 这个handleMessage我们就比较熟悉了。这个就是我们在重写Handler的时候需要自己实现的
     */
     ...
     * Hanlder的进行消息处理的逻辑在这个地方
     */
    public void dispatchMessage(@NonNull Message msg) {
        //callback不为null  则进行handleCallback
        // 所以我们要看一下这个callback是个什么东西？？
    ...
    /**
     * 当前线程里面的looper对象创建的消息队列MessageQueue
     */
