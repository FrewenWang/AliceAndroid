...
public final class SystemServer {
    ...
    private void run() {
        ...
        try {
            ...
            //startBootstrapServices函数中用SystemServiceManager
            //启动了ActivityManagerService、PowerManagerService、PackageManagerService等服务。
            startBootstrapServices();
            // 启动了BatteryService、UsageStatsService和WebViewUpdateService
            startCoreServices();
            // startOtherServices函数中则启动了CameraService、AlarmManagerService、VrManagerService等服务
        ...
        // Loop forever. 启动SystemServer进程的loop
        Looper.loop();
    ...
    private void startBootstrapServices() {
        ...
        // 判断PackageManagerService是否是手气启动
    ...
    private void startOtherServices() {
        ...
        try {
            ...
            // 通过WMS的静态方法main获取—个WindowManagerService对象
            wm = WindowManagerService.main(context, inputManager, !mFirstBoot, mOnlyCore,
                    new PhoneWindowManager(), mActivityManagerService.mActivityTaskManager);
            // 将WMS添加至ServiceManager中
            // 此后其他进程就可以通过用ServiceManager查询“window”来获取WMS。
