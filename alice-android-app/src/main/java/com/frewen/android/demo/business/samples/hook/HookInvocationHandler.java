package com.frewen.android.demo.business.samples.hook;
...
public class HookInvocationHandler implements InvocationHandler {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        if ("startActivity".equals(method.getName())) {
            ...
            subIntent.setClassName(packageName, "com.frewen.android.demo.logic.samples.hook.target.TargetActivity");
