 ...
 */
class AliceNetworkApi : AbsNetworkApi() {
    ...
    companion object {
        ...
        @Volatile
        private var sInstance: AliceNetworkApi? = null
        val instance: AliceNetworkApi
            get() {
                if (sInstance == null) {
                    synchronized(AliceNetworkApi::class.java) {
                        if (sInstance == null) {
                            sInstance = AliceNetworkApi()
                        }
                    }
                }
                return sInstance!!
