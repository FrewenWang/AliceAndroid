...
import com.frewen.aura.toolkits.utils.StringUtil;
...
public class PrettyFormatStrategy implements IFormatStrategy {
    ...
    private String formatTag(@Nullable String tag) {
        if (!StringUtil.isEmpty(tag) && !StringUtil.equals(this.tag, tag)) {
            return this.tag + "-" + tag;
        }
        return this.tag;
    }
