...
public class DiskLogStrategy implements LogStrategy {
    ...
    public DiskLogStrategy(@NonNull Handler handler) {
        this.handler = Preconditions.notNull(handler);
    }
    ...
    static class WriteHandler extends Handler {
        ...
        WriteHandler(@NonNull Looper looper, @NonNull String folder, int maxFileSize) {
            super(Preconditions.notNull(looper));
            this.folder = Preconditions.notNull(folder);
        ...
        private void writeLog(@NonNull FileWriter fileWriter, @NonNull String content) throws IOException {
            Preconditions.notNull(fileWriter);
        ...
        private File getLogFile(@NonNull String folderName, @NonNull String fileName) {
            Preconditions.notNull(folderName);
