package com.frewen.demo.library.media;
...
//        mBuffer = null;
    ...
    private static Size chooseOptimalSize(Size[] choices, int textureWidth, int textureHeight, int maxWidth, int maxHeight, Size aspectRatio) {
        ...
        for (Size option : choices) {
            if (option.getWidth() <= maxWidth && option.getHeight() <= maxHeight && option.getWidth() == option.getHeight() * w / h) {
