...
import com.frewen.aura.framework.mvvm.model.BaseModel

data class CommunityRecommendModel(val itemList: List<Item>, val count: Int, val total: Int, val nextPageUrl: String?, val adExist: Boolean) : BaseModel() {
