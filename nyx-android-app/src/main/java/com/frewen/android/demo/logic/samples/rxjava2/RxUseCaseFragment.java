...
import com.frewen.android.demo.logic.samples.rxjava2.usecase.RxNetSingleActivity;
    ...
    private void initData() {
        ...
        data.add(new ContentData("线程调度需要注意的",
                "RxJava 内置的线程调度器的确可以让我们的线程切换得心应手，但其中也有些需要注意的地方。\n" +
                        ...
                        "- 但多次指定订阅者接收线程是可以的，也就是说每调用一次 observerOn()，下游的线程就会切换一次。", HomeActivity.class));
    }
